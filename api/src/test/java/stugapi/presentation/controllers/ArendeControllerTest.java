...
public class ArendeControllerTest {
  ...
  public void whenGetAllArende_thenReturnAllArende() throws Exception {
    ...
    mvc.perform(MockMvcRequestBuilders
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$[0].status").value("CLOSED"))
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$[0].updates[1].status").value("CLOSED"))
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$[1].updates[1].status").value("CLOSED"))
